  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-gray-50">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Repo Rewards</h1>
        <p className="text-lg text-gray-600 max-w-md">
          Connect with GitHub to claim rewards for your open source contributions. Track your impact and earn recognition.
        </p>
      </div>
